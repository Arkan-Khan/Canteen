// src/components/LoginCanteen.jsx
...
export default function LoginCanteen() {
  ...
  function login() {
    axios.post(`http://localhost:5000/canteen/login`, values).then((res) => {
      if (res.data.msg) {
        ...
        navigate('/canteen/orders'); // Navigate on successful login
      }
    });
  }
    ...
    <div className="login">
      ...
      <form style={{ textAlign: 'left' }} onSubmit={handleSubmit}>
        ...
        <InputGroup
          ...
          name="password"
          type="password" // Set type for password field
          onChange={handleChange}
        />
